...
> ```
> A resident may also keep the file locked, especially on Windows. Run `officecli close <file>` before moving, renaming, or deleting it, or before opening it in another program.
