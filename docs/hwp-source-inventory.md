...
| rhwp repository | https://github.com/edwardkim/rhwp | 2026-06-21 KST | `de02159ab4d2c5d165d6e25568bad3f8af5ef6cb` (`v0.7.16`) | pinned in `src/rhwp-field-bridge/Cargo.toml`; exposes the five native operations listed in the sidecar contract | Candidate upstream HWP/HWPX read/render/edit engine only; OfficeCLI claims remain bounded by the parity matrix and tests. |
