...
static partial class CommandBuilder
{
    ...
    /// </summary>
    /// <remarks>
    /// Lived in upstream's CommandBuilder.Set.cs before the fork reset and was
    /// removed there. Only HWP routes still use it (a field/text value can
    /// arrive as value/text/new, and now also via upstream's --replace), so it
    /// belongs in this partial rather than grafted back into an upstream file.
    /// </remarks>
