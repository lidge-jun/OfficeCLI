...
public partial class HwpxHandler
{
    ...
    /// </summary>
    /// <remarks>
    /// <paramref name="properties"/> carries Word-only trackChange.* keys, which
    /// request a w:del revision instead of a physical delete. HWPX has no
    /// equivalent revision model, so the parameter is accepted for interface
    /// compatibility and ignored — removal here is always physical.
    /// </remarks>
    ...
    /// <remarks>
    /// <paramref name="properties"/> is the Word-only track-change channel; see
    /// Remove. Ignored for HWPX.
    /// </remarks>
