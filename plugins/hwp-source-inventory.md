...
| rhwp repository | https://github.com/edwardkim/rhwp | 2026-06-20 KST | `de02159ab4d2c5d165d6e25568bad3f8af5ef6cb` (`v0.7.16`) | `git ls-remote --tags ... refs/tags/v0.7.16`; pinned in `src/rhwp-field-bridge/Cargo.toml` | Candidate upstream HWP/HWPX read/render/edit engine only; no OfficeCLI support claim. |
